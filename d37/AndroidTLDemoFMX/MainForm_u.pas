...
uses
  ...
  FMX.TreeView, FMXPropTreeView, FMX.Layouts, FMX.ListBox, A.DsgnForms_u, FMX.Info_u, FMX.Math_u, GraphFrameFMX_u,
  AppEquationFrameFMX_u, FMX.Graph, FMX.GraphV, FMX.Graph3D, FMX.LRichEdit, FMX.Objects, FMX.Types3D,
  System.Math.Vectors, FMX.LicenceComponent, FMX.Variables, GraphVFrameFMX_u, FMX.Edit, FMX.EditBox, FMX.ImgList,
  FMX.SpinBox, FMX.BitButtons, FMX.Grid, FMX.PagesListBox, FMX.Rpt, System.ImageList, FMX.RptGraph, FMX.RptGraph3D,
  Info_u, ListEditor, FMX.SaveFilesDialog;
...
type
  TMainForm = class(TDsgnFormFMX)
    ...
    procedure Eq3VisibleClick(Sender: TObject);
  private
...
uses
  Math, FMX.DesignEditors, FMX.DesignIntf, Vassbotn.Vcl.Complex, FEM_u, System.Rtti, System.Threading
...
begin
  ...
  PropertyTreeViewFMX1.HWidth := 120;
end;
...
begin
  ...
  Canvas.Fill.Kind := TBrushKind.Solid;
  Canvas.Fill.Color := TAlphaColors.Black;
  EquationFMX2.Paint(Canvas, 'H = ', 10, 250);
...
begin
  ...
  try
    ...
    begin
      P := TPersistent(ListBox1.Items.Objects[Item.Index]);
      PropertyTreeViewFMX1.Persistent := P;
    end;
  finally
    AList.Free;
...
begin
  ...
  if not EquationFMX4.IsError then
    EquationFMX4.Paint(PaintBox1.Canvas, 'a2 = ', 10, 60);
end;
...
begin
  ...
  UpdateRec.Variable := FloatVectorQE;
...
procedure TMainForm.Eq3VisibleClick(Sender: TObject);
begin
  Graph3DFMX1.Repaint;
end;
