...
procedure BuildMatrixBeamK(K: TFloatMatrixFMX; OI, OJ: Integer; E, J, Lp: Double);
procedure BuildMatrixBeamM(M: TFloatMatrixFMX; OI, OJ: Integer; Ro, A, Lp: Double);
procedure BuildMatrixB(B, M, K: TFloatMatrixFMX; Alfa, Beta: Double);
procedure BeamAprox(X, Lp: Double; var A1, A2, A3, A4: Double);

implementation

uses
  Math, Vassbotn.Vcl.Complex, FMX.Math_u;
